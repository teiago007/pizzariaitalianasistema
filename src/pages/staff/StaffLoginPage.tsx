...
import { Eye, EyeOff, Mail, UserCog } from "lucide-react";
...
const StaffLoginPage: React.FC = () => {
  ...
  const { login, isAuthenticated, isLoading } = useStaff();
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-muted/50 rounded-lg">
              <p className="text-xs text-muted-foreground text-center">
                Para liberar um funcionário, crie o usuário e atribua o role <strong>staff</strong> na tabela
