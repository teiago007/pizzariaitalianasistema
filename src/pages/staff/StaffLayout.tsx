...
const StaffLayout: React.FC = () => {
  const { isAuthenticated, isLoading, logout } = useStaff();
      ...
      >
        <div className="flex flex-col flex-1 bg-card border-r border-border overflow-hidden">
          <div className="flex items-center gap-3 px-6 py-5 border-b border-border">
            <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-lg">🍕</div>
            {isSidebarOpen && (
              <div>
      ...
      <header className="lg:hidden sticky top-0 z-50 bg-card border-b border-border">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="font-display font-bold text-foreground">Atendimento</span>
          </div>
